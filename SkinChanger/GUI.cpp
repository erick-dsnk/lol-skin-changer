...
inline static void footer() noexcept
{
	...
	ImGui::textUnformattedCentered("Copyright (C) 2023 Eric Tabacaru");
}
...
void GUI::render() noexcept
{
	...
	ImGui::Begin("SkinChanger", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_AlwaysAutoResize);
	{
		ImGui::rainbowText();
