...
namespace SkinChangerInjector {
	...
	public ref class SkinChangerUI : public System::Windows::Forms::Form {
	public:
		SkinChangerUI(void) { InitializeComponent(); loadSettings(); }
	public:
		void updateScreen() {
			while (true) {
				if (clientState) {
		...
		void saveSettings() {
			...
			auto settingsFolder = Path::Combine(appDataPath, L"SkinChanger");
			auto settingsFilePath = Path::Combine(settingsFolder, L"SkinChangerInjector");
	...
	protected:
		~SkinChangerUI() { if (components) delete components; }
...
#pragma region Windows Form Designer generated code
		   ...
		   {
			   auto resources = (gcnew System::ComponentModel::ComponentResourceManager(SkinChangerUI::typeid));
			   ...
			   this->button1->Click += gcnew System::EventHandler(this, &SkinChangerUI::button1_Click);
			   // 
			   // label1
			   // 
			   ...
			   this->groupBox4->Text = L"SkinChangerSkin Status";
			   // 
			   // linkLabel1
			   // 
			   ...
			   this->linkLabel1->Text = L"Copyright (c) 2023 Eric Tabacaru";
			   this->linkLabel1->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			   this->linkLabel1->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &SkinChangerUI::linkLabel1_LinkClicked);
			   //
			   // contextMenu
			   //
			   ...
			   this->menuItem2->Click += gcnew System::EventHandler(this, &SkinChangerUI::menuItem2_OnClick);
			   this->menuItem->Index = 1;
			   this->menuItem->Text = L"Exit";
			   this->menuItem->Click += gcnew System::EventHandler(this, &SkinChangerUI::menuItem_OnClick);
			   //
			   // notifyIcon
			   //
			   this->notifyIcon->Text = L"SkinChanger";
			   this->notifyIcon->Icon = (cli::safe_cast<System::Drawing::Icon^>(resources->GetObject(L"$this.Icon")));
			   this->notifyIcon->Visible = false;
			   this->notifyIcon->ContextMenu = this->contextMenu;
			   this->notifyIcon->MouseDoubleClick += gcnew System::Windows::Forms::MouseEventHandler(this, &SkinChangerUI::notifyIcon_MouseDoubleClick);
			   //
			   // menuStrip
			   //
			   this->toolstripmenuItem->Text = L"Preferences";
			   this->toolstripmenuItem2->Text = L"Hide to tray";
			   this->toolstripmenuItem2->Click += gcnew System::EventHandler(this, &SkinChangerUI::toolstripmenuItem2_OnClick);
			   ...
			   this->Name = L"SkinChangerUI";
			   this->RightToLeft = System::Windows::Forms::RightToLeft::No;
			   this->Text = L"SkinChangerSkin";
			   this->Load += gcnew System::EventHandler(this, &SkinChangerUI::SkinChangerUI_Load);
			   this->Resize += gcnew System::EventHandler(this, &SkinChangerUI::SkinChangerUI_Resize);
...
#pragma endregion
	private:
		System::Void SkinChangerUI_Load(System::Object^ sender, System::EventArgs^ e) 
		{
			System::AppDomain::CurrentDomain->UnhandledException += gcnew System::UnhandledExceptionEventHandler(this, &SkinChangerUI::SkinChangerUI_ExceptionHandler);
		}
	private:
		System::Void SkinChangerUI_ExceptionHandler(System::Object^ sender, System::UnhandledExceptionEventArgs^ e)
		{
	...
	private:
		...
		{
			System::Diagnostics::Process::Start(L"https://github.com/erick-dsnk");
		}
	private:
		System::Void SkinChangerUI_Resize(System::Object^ sender, System::EventArgs^ e)
		{
